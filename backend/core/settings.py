...
# --- Logging ---
# Without this, DRF swallows 500 exceptions and returns them to the client
# without ever writing a traceback to the journal. This block makes every
# 500 visible in `journalctl -u gardenhouse-backend -f`.
LOGGING = {
    'version': 1,
